    ...
    render() {
        return (
            <div style={{ display: this.props.show ? 'block' : 'none' }}>
                ...
                <Pagination className="myPage" hideOnSinglePage={true} current={this.state.page} onChange={this.pageChange} simple defaultCurrent={1} total={this.state.count} />
            </div>
        )
    }
    pageChange(page) {
        axios.post('/mymd/move/all', { page }).then(rel => {
